...
import { Mail, Lock, ArrowRight, Loader2, Briefcase, ArrowLeft, Eye, EyeOff } from 'lucide-react';
    ...
    return (
        <div style={{
            ...
            <style>{`
                ...
                .login-input:focus{border-color:#0d9488 !important;box-shadow:0 0 0 3px rgba(13,148,136,.1)}
                .sign-in-btn:hover{transform:translateY(-1px);box-shadow:0 6px 20px rgba(13,148,136,.3)}
                .sign-in-btn:active{transform:none;box-shadow:none}
            `}</style>
            ...
            <div style={{
                ...
                <div style={{textAlign:'center',marginBottom:28}}>
                    ...
                    <p style={{fontSize:14,color:'#9ca3af'}}>Sign in to continue your journey</p>
                </div>
